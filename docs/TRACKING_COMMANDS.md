...
```bash
# Clean start
pkill -f "src/nodes/network_node.py" && pkill -f "src/clients/mining_client.py"

# Start node
python3 src/nodes/network_node.py --node-id core0 --api-port 5000 --p2p-port 8000 &

# Start mining
python3 src/clients/mining_client.py --wallet test_miner --node http://localhost:5000 &
```
...
python3 src/tools/blockchain_tracker_with_json.py analyze

# Custom filename
python3 src/tools/blockchain_tracker_with_json.py analyze http://localhost:5000 my_blockchain_report.json

# Quick analysis without saving
python3 src/tools/blockchain_tracker_with_json.py quick
```
...
python3 src/monitoring/blockchain_monitor.py monitor http://localhost:5001
```
...
**💡 Tip**: Use `src/tools/blockchain_tracker_with_json.py analyze` to generate comprehensive reports for blockchain auditing and performance analysis!