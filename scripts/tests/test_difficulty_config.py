...
def test_network_node_config():
    ...
    try:
        import src.nodes.network_node
        print(f"✅ Network node imports config successfully")
        print(f"   BLOCKCHAIN_DIFFICULTY = {src.nodes.network_node.BLOCKCHAIN_DIFFICULTY}")
        ...
        block = src.nodes.network_node.Block(0, [test_tx], "0" * 64)
...
def test_difficulty_consistency():
    ...
    try:
        ...
        network_difficulty = src.nodes.network_node.BLOCKCHAIN_DIFFICULTY
