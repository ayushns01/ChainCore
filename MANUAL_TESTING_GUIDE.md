...
python3 test_difficulty_config.py
```
...
```bash
# Terminal 3:
python3 mining_client.py --wallet test_miner_address --node http://localhost:5000
```
...
python3 quick_blockchain_check.py hashchain http://localhost:5000
python3 quick_blockchain_check.py hashchain http://localhost:5001
...
```bash
# Terminal 6:
python3 mining_client.py --wallet second_miner_address --node http://localhost:5001
```
...
python3 wallet_client.py balance --wallet bob.json --node http://localhost:5000
```
...
python3 mining_client.py --wallet $ALICE_ADDR --node http://localhost:5000
```
...
watch -n 3 '
echo "Alice: $(python3 wallet_client.py balance --wallet alice.json --node http://localhost:5000 | grep Balance)"
echo "Bob:   $(python3 wallet_client.py balance --wallet bob.json --node http://localhost:5000 | grep Balance)"
...
python3 mining_client.py --wallet miner3_addr --node http://localhost:5002 &
```
...
1. **Check configuration**: `python3 test_difficulty_config.py`
...
python3 blockchain_monitor.py analyze
