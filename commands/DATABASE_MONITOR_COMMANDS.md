...
|---------|-------------|----------|
| `python database_monitor.py --status-only` | Show current database state | 5 seconds |
| `python database_monitor.py` | Start real-time monitoring | Continuous |
| `python database_monitor.py --interval 5` | Monitor with 5-second refresh | Continuous |
...
python database_monitor.py --interval 0.5
```

### **Help Command**
```bash
python database_monitor.py --help
```
...
python database_monitor.py --interval 10
```
...
python database_monitor.py --status-only
```
**Solution:** Start mining client: `python mining_client.py --wallet 1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa --node http://localhost:5000`
...
2. Verify credentials in `src/database/simple_connection.py`
...
```bash
python network_node.py --node-id core1 --api-port 5001 --p2p-port 8001 --bootstrap-node http://localhost:5000
```
...
```bash
# Node 2
python network_node.py --node-id core2 --api-port 5002 --p2p-port 8002 --bootstrap-node http://localhost:5000

# Node 3
python network_node.py --node-id core3 --api-port 5003 --p2p-port 8003 --bootstrap-node http://localhost:5000
```
...
| Command | Purpose |
|---------|---------|
| `python simple_db_test.py` | Test database connectivity |
| `python test_simple_integration.py` | Test full integration |
| `python network_node.py --help` | Network node options |
| `python mining_client.py --help` | Mining client options |
